...
#testing getting cpu count    
import multiprocessing
procs1=multiprocessing.cpu_count()
print("procs1 %d frm multiprocessing - available from rank %d" % (procs1,rank))

#import psutil
#procs2=psutil.cpu_count()
#print("procs2 %d frm psutil - available from rank %d" % (procs2,rank))

#procs3=os.cpu_count()
#print("procs3 %d frm os.cpu_count - from rank %d" % (procs3,rank))

#proc4=len(os.sched_getaffinity(0)) #should give usable cpu's.
#print("procs4 %d frm os.sched_getaffinity(0) - from rank %d" % (procs4,rank))
